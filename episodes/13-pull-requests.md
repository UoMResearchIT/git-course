...
![](fig/github-diagram.png){alt='Conceptual illustration of a pull request - image adapted fromhere'}
...
1. **Fork** [this
  ...
  ![](fig/fork-a-repo.png){alt='screenshot of fork button'}

2. Navigate back to your home directory so you don't clone into an existing repo
  in the next step
...
3. Clone the repository from **YOUR** GitHub account.
...
2. Go to your GitHub account and in the forked repository find a green button
  for creating Pull Requests. Click it and follow the instructions.
3. The owner of the original repository gets a notification that someone
