...
[GitHub](https://github.com) is a company which provides remote repositories for
...
![](fig/github-ssh-address.png){alt='ssh-address'}
...
Now, if we `cd` into *laptop\_paper* we can see that we have our repository,
