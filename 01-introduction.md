...
http://www.phdcomics.com](https://www.phdcomics.com)](fig/phd101212s.png)
...
![](fig/play-changes.svg){alt='Add changes sequentially'}

Save different versions
![](fig/versions.svg){alt='Save different versions'}

Merge different versions
![](fig/merge.svg){alt='Merge different versions'}
...
and [GitHub](https://github.com), a web-based service providing remote
