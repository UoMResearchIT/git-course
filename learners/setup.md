...
1. [Create SSH keys on your laptop](learners/setup.md#create-ssh-keys)
2. [Add the public key to GitHub](learners/setup.md#add-public-ssh-key-to-github)
...
- Add a title e.g. "my\_work\_laptop" and paste your SSH key into
